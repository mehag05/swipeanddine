...
export default function Home() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.headerTitle}>Swipe & Dine</Text>
      
      <View style={styles.content}>
        <FontAwesome name="cutlery" size={80} color="#E75480" style={styles.icon} />
        <Text style={styles.oopsText}>Find your taste</Text>
        <Text style={styles.message}>
          Swipe left or right to find the best restaurant for your current taste!
        </Text>
